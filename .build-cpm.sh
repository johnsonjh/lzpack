...
MCAP_Z80_LZPACK="${MCAP_Z80_LZPACK:-21778}"
MCAP_Z80_LZUNPACK="${MCAP_Z80_LZUNPACK:-13733}"
MCAP_Z80_STUBASM="${MCAP_Z80_STUBASM:-27760}"
MCAP_8080_LZPACK="${MCAP_8080_LZPACK:-23075}"
MCAP_8080_LZUNPACK="${MCAP_8080_LZUNPACK:-14973}"
