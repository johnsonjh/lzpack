...
MCAP_Z80_LZPACK="${MCAP_Z80_LZPACK:-21811}"
MCAP_Z80_LZUNPACK="${MCAP_Z80_LZUNPACK:-13895}"
MCAP_Z80_STUBASM="${MCAP_Z80_STUBASM:-27766}"
MCAP_8080_LZPACK="${MCAP_8080_LZPACK:-23184}"
MCAP_8080_LZUNPACK="${MCAP_8080_LZUNPACK:-15176}"
MCAP_8080_STUBASM="${MCAP_8080_STUBASM:-28650}"
