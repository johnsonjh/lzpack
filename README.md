...
|----------:|----------:|-----------------------:|-----------------------:|-----------------------:|-----------------------:|-----------------------:|
| `BLS`     | `19,210`  | `12,160`&nbsp;(`‑36.7`<small>%</small>) | `11,884`&nbsp;(`‑38.1`<small>%</small>) | `12,150`&nbsp;(`‑36.8`<small>%</small>) | `12,542`&nbsp;(`‑34.7`<small>%</small>) | `12,552`&nbsp;(`‑34.7`<small>%</small>) |
| `FORTH80` | `8,136`   |  `6,272`&nbsp;(`‑22.9`<small>%</small>) |  `6,093`&nbsp;(`‑25.1`<small>%</small>) |  `6,139`&nbsp;(`‑24.5`<small>%</small>) |  `6,454`&nbsp;(`‑20.7`<small>%</small>) |  `6,458`&nbsp;(`‑20.6`<small>%</small>) |
| `M80`     | `20,023`  | `13,952`&nbsp;(`‑30.3`<small>%</small>) | `13,702`&nbsp;(`‑31.6`<small>%</small>) | `14,024`&nbsp;(`‑30.0`<small>%</small>) | `14,528`&nbsp;(`‑27.4`<small>%</small>) | `14,545`&nbsp;(`‑27.4`<small>%</small>) |
| `MBASIC`  | `24,313`  | `19,456`&nbsp;(`‑20.0`<small>%</small>) | `19,178`&nbsp;(`‑21.1`<small>%</small>) | `19,569`&nbsp;(`‑19.5`<small>%</small>) | `20,139`&nbsp;(`‑17.2`<small>%</small>) | `20,160`&nbsp;(`‑17.1`<small>%</small>) |
| `PILOT`   | `30,902`  | `13,184`&nbsp;(`‑57.3`<small>%</small>) | `12,792`&nbsp;(`‑58.6`<small>%</small>) | `13,277`&nbsp;(`‑57.0`<small>%</small>) | `13,582`&nbsp;(`‑56.0`<small>%</small>) | `13,588`&nbsp;(`‑56.0`<small>%</small>) |
| `SARGON`  | `14,592`  |  `8,704`&nbsp;(`‑40.4`<small>%</small>) |  `8,593`&nbsp;(`‑41.1`<small>%</small>) |  `8,689`&nbsp;(`‑40.5`<small>%</small>) |  `9,183`&nbsp;(`‑37.1`<small>%</small>) |  `9,178`&nbsp;(`‑37.1`<small>%</small>) |
| `VDT1398` | `17,443`  | `13,056`&nbsp;(`‑25.2`<small>%</small>) | `12,874`&nbsp;(`‑26.2`<small>%</small>) | `13,117`&nbsp;(`‑24.8`<small>%</small>) | `13,633`&nbsp;(`‑21.8`<small>%</small>) | `13,639`&nbsp;(`‑21.8`<small>%</small>) |
| `VDT139Z` | `16,485`  | `12,544`&nbsp;(`‑23.9`<small>%</small>) | `12,325`&nbsp;(`‑25.2`<small>%</small>) | `12,561`&nbsp;(`‑23.8`<small>%</small>) | `12,894`&nbsp;(`‑21.8`<small>%</small>) | `12,902`&nbsp;(`‑21.7`<small>%</small>) |
| `VDT232Z` | `24,304`  | `18,688`&nbsp;(`‑23.1`<small>%</small>) | `18,430`&nbsp;(`‑24.2`<small>%</small>) | `18,893`&nbsp;(`‑22.3`<small>%</small>) | `19,363`&nbsp;(`‑20.3`<small>%</small>) | `19,375`&nbsp;(`‑20.3`<small>%</small>) |
| `WS30`    | `15,872`  | `11,648`&nbsp;(`‑26.6`<small>%</small>) | `11,425`&nbsp;(`‑28.0`<small>%</small>) | `11,539`&nbsp;(`‑27.3`<small>%</small>) | `12,221`&nbsp;(`‑23.0`<small>%</small>) | `12,224`&nbsp;(`‑23.0`<small>%</small>) |
| `ZORK1`   | `8,426`   |  `5,376`&nbsp;(`‑36.2`<small>%</small>) |  `5,276`&nbsp;(`‑37.4`<small>%</small>) |  `5,338`&nbsp;(`‑36.6`<small>%</small>) |  `5,542`&nbsp;(`‑34.2`<small>%</small>) |  `5,546`&nbsp;(`‑34.2`<small>%</small>) |
