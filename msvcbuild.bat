REM LZPACK - msvcbuild.bat
REM Copyright (c) 2026 Jeffrey H. Johnson <johnsonjh.dev@gmail.com>
REM SPDX-License-Identifier: MIT-0
REM vim: set ft=dosbatch cc=80 :
REM scspell-id: 3e847470-632a-11f1-b7db-80ee73e9b8e7
