  ...
  while (*p)
    {
      ...
      if (SP_MAXTXT - 1 <= sp_total + n)
        return -1;

      sp_text[sp_off[sp_nstr] + n++] = (unsigned char)c;
    }

  sp_text[sp_off[sp_nstr] + n] = 0;
...
write_header (FILE *f)
{
  ...
  (void)fprintf (f,
    "/*\n"
    " * Generated by strpack - DO NOT EDIT.\n"
    " * With LZ_MSG_PACKED defined the MSG_* names resolve to strings\n"
    " * coded against a shared dictionary: bytes 0x00..0x7F are\n"
    " * literals, 0x80.. index lz_msgbook entries (length-prefixed).\n"
    " * Decode with lz_mputs()/lz_mload().  Without LZ_MSG_PACKED the\n"
    " * same names are ordinary string literals.\n"
    " */\n\n");
